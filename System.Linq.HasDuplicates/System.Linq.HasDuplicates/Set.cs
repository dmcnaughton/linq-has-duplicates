...
namespace System.Linq.HasDuplicates
{
    internal sealed class Set<TElement>
    {
        ...
        /// <summary>
        /// This needs a better name, but this is meant to easily output a Dictionary of the elements with the object as the key and the count as the value.
        /// </summary>
        /// <returns></returns>
...
#endif
            return _slots.Where(x => x._count > 1).Select(x => new KeyValuePair<TElement, int>(x._value, _count));
        }
        ...
        private struct Slot
        {
            ...
            /// <summary>
            /// The number of times this entity has been hit in the collection
            /// </summary>
            internal int _count;
        }
    }
